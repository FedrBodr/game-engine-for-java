...
/**
 * This class acts as a configured JFrame which is equipped with special abilities. It can be
 * configured to start as a full screen application, or a windowed application. It is invoked like
 * this.<br>
 * 
 * <pre>
 ...
 * </pre>
 * 
 * where the values provided are the default ones. The constructors are discussed again at their
 ...
 * <li>Monitors and changes the window size, title, fullscreen state by scanning the Global class
...
public class GWindow extends JFrame implements ActionListener {
    ...
    /**
     * This method fixes the repaint issue (flickering) on old machines with latest JRE. It is
    ...
    /**
     * This is our default constructor. Create instances by using the setup() method. The arguments
     * to be passed except the Game are just the default one's. They can be changed during the game
     * play. (use global.HEIGHT = 240;)
    ...
    private GWindow(Game game, String title, int width, int height){
        ...
        addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent e){
                int retVal = JOptionPane.showOptionDialog(null, "Are you sure want to exit?", Global.TITLE, JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, new String[]{ "Sure, close it!", "Sorry! Go Back!" }, "Sorry! Go Back!");
    ...
    /**
     * Called by the timer each second to update the window state, such as title, window size,
     * resolution in full-screen state etc.,
     */
