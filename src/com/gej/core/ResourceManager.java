...
/**
 * A resource manager to load the resources in separate thread. Can load images
 * and sounds and say the load percentage. Get the resources from the manager
 * and assign them in the update() method of the Game class like this.
 * 
 * <pre>
 * 
 * Image myImg = null;
