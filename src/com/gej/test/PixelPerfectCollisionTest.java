...
public class PixelPerfectCollisionTest extends Game {
    ...
    public void initResources(){
        font = new GFontAnimated();
        font.addFont(GFontAdvanced.getFont(loadImage("ImageFonts/font_blue.png"), "ImageFonts/DefFontDescriptor.txt"), 150);
        font.addFont(GFontAdvanced.getFont(loadImage("ImageFonts/font_brown.png"), "ImageFonts/DefFontDescriptor.txt"), 150);
