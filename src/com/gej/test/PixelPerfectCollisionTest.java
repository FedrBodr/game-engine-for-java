...
public class PixelPerfectCollisionTest extends Game {
	...
	public void initResources() {
		font = GFontAdvanced.getFont(loadImage("ImageFonts/font_blue.png"),
		...
		obj2.setX(150);
		obj2.setY(150);
		Background.setBackground(ImageTool.getColoredImage(Color.LIGHT_GRAY,
	...
	public void update(long elapsedTime) {
		Global.TITLE = "Pixel perfect collision detection : FPS : "
