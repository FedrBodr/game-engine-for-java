...
/**
 * An enumeration containing constants used for
 * maintaining directions. Only four directions
 * and a constant for no direction. So use two
 * fields for vertical and horizontal directions.
 * For use in objects, use the preprogrammed
...
public enum Direction {
    ...
    /**
     * Checks if a direction is horizontal. Returns false even
    ...
    /**
     * Checks if a direction is vertical. Returns false even
     * if the direction is none.
     * @param dir The direction
