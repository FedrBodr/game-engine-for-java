...
/**
 * A tile is a type of object which just sit's there
 * and doesn't do anything. Often used to decorate maps
 * or for fake wall's etc., Note that they cannot be
 * destroyed while the map is running and they are not
 * animated too.
 * 
