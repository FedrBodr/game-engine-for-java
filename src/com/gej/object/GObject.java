...
/**
 * This class represents objects in a game. Any object must extend this class. The events are
 * automatically managed if this object is dynamically loaded through a map loader. Else you have to
...
public class GObject implements Updateable {
    ...
    /**
     * Checks if this object is colliding the other object. You can enable pixel-perfect collision
     * detection by using
     * 
     * <pre>
    ...
    /**
     * Destroy's this object so that it won't receive any events and will not render again.
     */
    public void destroy(){
        alive = false;
    ...
    /**
     * Moves this object to a specified point with a specific speed. Note that the velocity used is
     * independent of vertical or horizontal velocities of this object.
     * @param nx The new x-position
     * @param ny The new y-position
    ...
    /**
     * Changes the velocities of this object in order to get a bounce effect over the object.
     */
    public void bounce(){
        boolean left = false;
        boolean right = false;
    ...
    /**
     * Moves this object to the next point which on next move would collide. Works perfectly only in
     * the pixel perfect collision detection mode. This automatically resets the velocities.
     * @param other The other object
     */
