...
/**
 * A customized object to move along directions. Useful if the object
 * moves in directions.
 * 
...
public class DirectionedGObject extends GObject {
    ...
    /**
     * Sets the direction of this object. Use this method
     * only to make movement in only one direction. If the
     * direction is horizontal, the vertical direction is
     * none. Else the horizontal direction is none.
     * @param dir The new direction
     */
    ...
    /**
     * Updates the velocities of this object based on the
