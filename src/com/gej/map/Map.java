...
/**
 * This class represents a map (tile-based of course!) which is currently playing the game. You
 * could use the MapManager class to control the order of maps. Note that this class is completely
 * static. A map requires MapInfo objects if you does't want to load from file ( so nobody can edit
 * your levels )
...
public abstract class Map {
    ...
    /**
     * Returns the character in the map file at the specified tile position of the object. ( Note
     * that it is only used for debugging ).
    ...
    /**
     * Renders the map at a specific position. visibleRect is the rectangle passed so that only the
     * visible objects are drawn.
     * @param g The graphics context
     * @param x The x-position
     * @param y The y-position
     */
    ...
    /**
     * Removes all objects of a class from this map. Useful to destroy all bombs etc., Example:
     * 
     * <pre>
     ...
     * @return True if the object is positioned exactly at the left corner of the grid
     */
