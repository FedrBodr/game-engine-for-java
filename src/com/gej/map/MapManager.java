...
/**
 * A manager to control the order of maps to be loaded. Has the flexibility to add new maps and to
 * load a null map. Can also be used to go to previous map or next map.
