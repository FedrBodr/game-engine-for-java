...
public class MapView {
	...
	/**
	 * Render's the map with this view. Only the visible objects and tiles are
	 * rendered.
	 * 
	...
	public static void renderObject(Graphics2D g, GObject obj) {
		try {
			g.drawImage(obj.getImage(), Math.round(obj.getX()) + OffSetX,
			        Math.round(obj.getY()) + OffSetY, null);
		} catch (NullPointerException e) {
		}
	}
