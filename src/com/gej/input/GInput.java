...
/**
 * Constitutes all the information to take input polling for a game. You could use the static
 * methods of the GKeyBoard and GMouse classes to check the key input.
...
public class GInput implements KeyListener, MouseListener, MouseMotionListener {
    ...
    /**
     * An invisible cursor made to hide the cursor in the game panel.
     */
    ...
    /**
     * The default constructor. Makes this class listen the events (key, mouse)
    ...
    /**
     * Adds another key-listener to customize the key input
    ...
    /**
     * Adds another mouse-listener to customize the mouse input
    ...
    /**
     * Adds another mouse-motion-listener to customize the input
    ...
    /**
     * Adds another mouse-wheel listener to customize the input
