...
/**
 * This class is used to load the fonts from their respective font-descriptor files. They are
 * created like this.
 * 
 * <pre>
...
public class GFontAdvanced {
    ...
    /**
     * Creates a new GFont object by parsing the data from a font-descriptor. Just type the
     * characters as in the same order of the image file. Note that all the characters should be in
     * the same width and size.
