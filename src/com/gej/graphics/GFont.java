...
/**
 * Represents a game font made from a single sprite sheet. Uses Images to represent alphabets. You
 * can use the GFontAdvanced class to load the fonts from the font descriptors like this.
 * 
 * <pre>
...
public class GFont {
    ...
    /**
     * Constructs a GFont object with a main image, numRows, numColumns and the order of alphabets
     * in the image.
     * @see ImageTool
    ...
    /**
     * This is the method which we use to draw text on the window. Note that the maximum length of
     * the string is 40 cols.
