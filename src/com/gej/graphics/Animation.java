...
/**
 * Contains a list of images and frame timing information to create an animation which is used by
 * the GObject's.
...
public class Animation {
    ...
    /**
     * This default constructor could be used to create an empty animation object. then use the
     * addFrame() method to add sub-images with a specific delay.
     */
    public Animation(){
    ...
    /**
     * This constructor is useful when you have same duration for every frame and could add frames
     * from an image array.
    ...
    /**
     * Skip this frame and move to the next one. Note that all the frames are looped constantly.
     */
    ...
    /**
     * Displays the previous frame. Note that all the frames are looped constantly.
     */
